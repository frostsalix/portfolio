<template>
  <div class="header-container">
    <h2 class="side-text" :class="{ hidden: scrolled }">WELCOME TO FROSTSALIX</h2>
    <div class="content">
      <!-- <div
        ref="avatarContainer"
      ...
      <div class="content-text">
        <p class="p-input animated-element" style="margin-bottom: 16px; animation-delay: 0.1s">
          <span style="color: #00d9ff">user@frostsalix</span>
        ...
        <h1 class="animated-element" style="animation-delay: 0.2s">
          ...
          <span style="color: white">frostsalix</span>
